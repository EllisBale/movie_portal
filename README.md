...
| User Feedback | The application provides clear, real-time feedback for all user actions. Success messages appear for login/logout, creating bookings (custom success page after completion), updating profiles, updating passwords, and deleting bookings (with a warning before final deletion). Error messages appear when invalid input is submitted. This ensures users always understand the outcome of their actions and improves overall UX.   | ![screenshot](docs/readme_imgs/signout_message.png) ![screenshot](docs/readme_imgs/loggedin_message.png) ![screenshot](docs/readme_imgs/profile_update_message.png) ![screenshot](docs/readme_imgs/password_message.png) ![screenshot](docs/readme_imgs/delete_booking_message.png) ![screenshot](docs/readme_imgs/delete_warning_message.png) ![screenshot](docs/readme_imgs/booking_success.png)  |
| User Feedback Admin/Staff | The application shows clear success messages for all admin and staff CRUD actions, confirming when actions like creating, updating, or deleting records are completed.   | ![screenshot](docs/readme_imgs/film_updated_message.png) ![screenshot](docs/readme_imgs/film_created_message.png) ![screenshot](docs/readme_imgs/film_deleted_message.png) ![screenshot](docs/readme_imgs/schedule_created_message.png) ![screenshot](docs/readme_imgs/schedule_updated_message.png) ![screenshot](docs/readme_imgs/schedule_deleted_message.png) ![screenshot](docs/readme_imgs/booking_updated_message.png) ![screenshot](docs/readme_imgs/booking_deleted_message.png) ![screenshot](docs/readme_imgs/user_updated_message.png) ![screenshot](docs/readme_imgs/user_deleted_message.png)   |
| Access Control & Security | The application uses Django decorators to restrict access to certain views. Users must be logged in to access profile or booking pages (`@login_required`). Admin/staff-only pages are protected (`@staff_member_required`), preventing unauthorized access. CSRF protection is enabled on all forms to prevent cross-site request forgery. If user doesn't have the permissions to the URL, they will be redirected to login/django page. | ![screenshot](docs/readme_imgs/login_url.png) ![screenshot](docs/readme_imgs/login_redirect.png) ![screenshot](docs/readme_imgs/admin_url.png) ![screenshot](docs/readme_imgs/django_redirect.png) |
| Heroku Deployment | The site is fully deployed to Heroku, making it accessible online and easy to manage. | ![screenshot](docs/readme_imgs/heroku.png) |
| 404 page | The website contains a custom 404 HTML page which is used when a user tries to access a non-existent page, providing a clear message and navigation option to return to the homepage.  | ![screenshot](docs/readme_imgs/404_page.png)   |

...
| --- | --- | --- | --- | --- |
| bookings | [book_seats.html](https://github.com/EllisBale/movie_portal/blob/main/bookings/templates/book_seats.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bookings-book_seats.png) | ⚠️ Notes (if applicable) |
| bookings | [bookings_success.html](https://github.com/EllisBale/movie_portal/blob/main/bookings/templates/bookings_success.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bookings-bookings_success.png) | ⚠️ Notes (if applicable) |
| bookings | [select_film.html](https://github.com/EllisBale/movie_portal/blob/main/bookings/templates/select_film.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bookings-select_film.png) | ⚠️ Notes (if applicable) |
| bookings | [select_schedule.html](https://github.com/EllisBale/movie_portal/blob/main/bookings/templates/select_schedule.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bookings-select_schedule.png) | ⚠️ Notes (if applicable) |
| films | [films.html](https://github.com/EllisBale/movie_portal/blob/main/films/templates/films.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-films-films.png) | ⚠️ Notes (if applicable) |
| films | [films_detail.html](https://github.com/EllisBale/movie_portal/blob/main/films/templates/films_detail.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-films-films_detail.png) | ⚠️ Notes (if applicable) |
| home | [index.html](https://github.com/EllisBale/movie_portal/blob/main/home/templates/home/index.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-home-index.png) | ⚠️ Notes (if applicable) |
| menu | [menu.html](https://github.com/EllisBale/movie_portal/blob/main/menu/templates/menu.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-menu-menu.png) | ⚠️ Notes (if applicable) |
| user_account | [login.html](https://github.com/EllisBale/movie_portal/blob/main/user_account/templates/account/login.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-user_account-login.png) | ⚠️ Notes (if applicable) |
| user_account | [logout.html](https://github.com/EllisBale/movie_portal/blob/main/user_account/templates/account/logout.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-user_account-logout.png) | ⚠️ Notes (if applicable) |
| user_account | [password_reset.html](https://github.com/EllisBale/movie_portal/blob/main/user_account/templates/account/password_reset.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-user_account-password_reset.png) | ⚠️ Notes (if applicable) |
| user_account | [signup.html](https://github.com/EllisBale/movie_portal/blob/main/user_account/templates/account/signup.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-user_account-signup.png) | ⚠️ Notes (if applicable) |
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| static | [style.css](https://github.com/EllisBale/movie_portal/blob/main/static/css/style.css) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/css-static-style.png) | ⚠️ Notes (if applicable) |
...
| bookings | [tests.py](https://github.com/EllisBale/movie_portal/blob/main/bookings/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/bookings/tests.py) | ![screenshot](documentation/validation/py-bookings-tests.png) | ⚠️ Notes (if applicable) |
| bookings | [urls.py](https://github.com/EllisBale/movie_portal/blob/main/bookings/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/bookings/urls.py) | ![screenshot](documentation/validation/py-bookings-urls.png) | ⚠️ Notes (if applicable) |
| bookings | [views.py](https://github.com/EllisBale/movie_portal/blob/main/bookings/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/bookings/views.py) | ![screenshot](documentation/validation/py-bookings-views.png) | ⚠️ Notes (if applicable) |
| films | [admin.py](https://github.com/EllisBale/movie_portal/blob/main/films/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/films/admin.py) | ![screenshot](documentation/validation/py-films-admin.png) | ⚠️ Notes (if applicable) |
| films | [models.py](https://github.com/EllisBale/movie_portal/blob/main/films/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/films/models.py) | ![screenshot](documentation/validation/py-films-models.png) | ⚠️ Notes (if applicable) |
| films | [tests.py](https://github.com/EllisBale/movie_portal/blob/main/films/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/films/tests.py) | ![screenshot](documentation/validation/py-films-tests.png) | ⚠️ Notes (if applicable) |
| films | [urls.py](https://github.com/EllisBale/movie_portal/blob/main/films/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/films/urls.py) | ![screenshot](documentation/validation/py-films-urls.png) | ⚠️ Notes (if applicable) |
| films | [views.py](https://github.com/EllisBale/movie_portal/blob/main/films/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/films/views.py) | ![screenshot](documentation/validation/py-films-views.png) | ⚠️ Notes (if applicable) |
| home | [admin.py](https://github.com/EllisBale/movie_portal/blob/main/home/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/home/admin.py) | ![screenshot](documentation/validation/py-home-admin.png) | ⚠️ Notes (if applicable) |
| home | [models.py](https://github.com/EllisBale/movie_portal/blob/main/home/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/home/models.py) | ![screenshot](documentation/validation/py-home-models.png) | ⚠️ Notes (if applicable) |
| home | [tests.py](https://github.com/EllisBale/movie_portal/blob/main/home/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/home/tests.py) | ![screenshot](documentation/validation/py-home-tests.png) | ⚠️ Notes (if applicable) |
| home | [urls.py](https://github.com/EllisBale/movie_portal/blob/main/home/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/home/urls.py) | ![screenshot](documentation/validation/py-home-urls.png) | ⚠️ Notes (if applicable) |
| home | [views.py](https://github.com/EllisBale/movie_portal/blob/main/home/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/home/views.py) | ![screenshot](documentation/validation/py-home-views.png) | ⚠️ Notes (if applicable) |
|  | [manage.py](https://github.com/EllisBale/movie_portal/blob/main/manage.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/manage.py) | ![screenshot](documentation/validation/py--manage.png) | ⚠️ Notes (if applicable) |
| menu | [admin.py](https://github.com/EllisBale/movie_portal/blob/main/menu/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/menu/admin.py) | ![screenshot](documentation/validation/py-menu-admin.png) | ⚠️ Notes (if applicable) |
| menu | [models.py](https://github.com/EllisBale/movie_portal/blob/main/menu/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/menu/models.py) | ![screenshot](documentation/validation/py-menu-models.png) | ⚠️ Notes (if applicable) |
| menu | [tests.py](https://github.com/EllisBale/movie_portal/blob/main/menu/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/menu/tests.py) | ![screenshot](documentation/validation/py-menu-tests.png) | ⚠️ Notes (if applicable) |
| menu | [urls.py](https://github.com/EllisBale/movie_portal/blob/main/menu/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/menu/urls.py) | ![screenshot](documentation/validation/py-menu-urls.png) | ⚠️ Notes (if applicable) |
| menu | [views.py](https://github.com/EllisBale/movie_portal/blob/main/menu/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/menu/views.py) | ![screenshot](documentation/validation/py-menu-views.png) | ⚠️ Notes (if applicable) |
| movie_portal | [settings.py](https://github.com/EllisBale/movie_portal/blob/main/movie_portal/settings.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/movie_portal/settings.py) | ![screenshot](documentation/validation/py-movie_portal-settings.png) | ⚠️ Notes (if applicable) |
| movie_portal | [urls.py](https://github.com/EllisBale/movie_portal/blob/main/movie_portal/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/movie_portal/urls.py) | ![screenshot](documentation/validation/py-movie_portal-urls.png) | ⚠️ Notes (if applicable) |
| user_account | [admin.py](https://github.com/EllisBale/movie_portal/blob/main/user_account/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/user_account/admin.py) | ![screenshot](documentation/validation/py-user_account-admin.png) | ⚠️ Notes (if applicable) |
| user_account | [forms.py](https://github.com/EllisBale/movie_portal/blob/main/user_account/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/user_account/forms.py) | ![screenshot](documentation/validation/py-user_account-forms.png) | ⚠️ Notes (if applicable) |
| user_account | [models.py](https://github.com/EllisBale/movie_portal/blob/main/user_account/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/user_account/models.py) | ![screenshot](documentation/validation/py-user_account-models.png) | ⚠️ Notes (if applicable) |
| user_account | [tests.py](https://github.com/EllisBale/movie_portal/blob/main/user_account/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/user_account/tests.py) | ![screenshot](documentation/validation/py-user_account-tests.png) | ⚠️ Notes (if applicable) |
| user_account | [views.py](https://github.com/EllisBale/movie_portal/blob/main/user_account/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/EllisBale/movie_portal/main/user_account/views.py) | ![screenshot](documentation/validation/py-user_account-views.png) | ⚠️ Notes (if applicable) |
...
|  Manage booking as User | Feature is expected to allow logged in users to view there bookings on a seperate page. | Log in as a user and make a booking then view your booking information on the "My Bookings" link on the navbar. When page has loaded, bookings should be visible. | User can view bookings they have made when logged in on the my_bookings page. | ![screenshot](docs/defensive_programming_imgs/my_bookings_test.png) |
| |  Feature is expected to allow logged in users to delete/cancel bookings they have made. | Logged in users goes and clicks delete button on their booking to remove it from page. | Logged in user can successfully delete their bookings by clicking on delete button. | ![screenshot](docs/defensive_programming_imgs/delete_booking_user_test.gif) |
